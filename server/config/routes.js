...
module.exports = function applyRoutes(app) {
  ...
  app.get('/:type(orders|accounts|portions|vendors|products)',
          passport.authenticate('jwt'), api);
  app.get('/:type(orders|accounts|portions|vendors|products)/:id',
          passport.authenticate('jwt'), api);
  app.patch('/:type(orders|portions)/:id',
            passport.authenticate('jwt'), api);
  app.post('/:type(orders|portions|vendors|products)',
           passport.authenticate('jwt'), api);
